...
NDiplomacy = {
	...
	PREP_INV_REQ_PRESTIGE = 1500,								-- Need to have this much Prestige to prepare an invasion
	...
	PREPARE_INVASION_INTERACTION_MONEY = 200,
...
NReligion = {
	...
	REFORM_RELIGION_PIETY_COST = 1000,				-- Piety cost of reforming a pagan faith
...
NEconomy = {
	...
	PATRICIAN_AGE_RESPECT_FACTOR = 0.5,				-- The effect of Age on the Respect value for Doge elections (age * age * factor)
...
NFrontend =
{
	...
	FRONTEND_POS_X = 400.0,		--FRONTEND_POS_X = 800.0,	
	FRONTEND_POS_Y = 100.0,	--FRONTEND_POS_Y = 1000.0,
	FRONTEND_POS_Z = 1000.0,		--FRONTEND_POS_Z = 500.0,	
	FRONTEND_LOOK_X = 550.0,	--FRONTEND_LOOK_X = 800.0,
	FRONTEND_LOOK_Y = 0.0,		--FRONTEND_LOOK_Y = 0.0,	
	FRONTEND_LOOK_Z = 1500.0,	--FRONTEND_LOOK_Z = 1024.0,
...
-- THIS MOD WAS MADE BY @STRIPED_, ANY WHO TRY TO COPY/STEAL IT I WILL REPORT
